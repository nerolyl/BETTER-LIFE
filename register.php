        ...
        <div class="register_imgs">
            ...
            <div class="inputs">
                ...
                <form action="includes/formhandler.inc.php" method="post">
                    ...
                    <input type="number" placeholder="Weight (kg)" name="weight" id="weight" required>
                    <input type="number" placeholder="Height (cm)" name="height" id="height" required>
                    <!-- tooltip -->
                    <div class ="tooltip_r">
                    ...
                    <input type="radio" id="male" name="gender" value="161" required>>
